...
fireballMatching.mainMenu = {
    ...
    create:function(){
        ...
        this.nextButton = this.game.add.button(this.game.world.width-30,this.game.world.centerY,"arrow",this.goToNextPage,this);
...
//    },
    ...
    goToNextPage:function(){
        this.currentPage++;
        this.game.state.start("mainMenu"+this.currentPage);
    },
